  ...
  return (
    <div className='flex justify-around py-4 px-4 border shadow-sm flex-col xl:flex-row'>
      ...
      <div className='flex flex-col font-semibold'>
        <Link className='transition transform hover:-translate-y-3 pb-3' to="/">HOME</Link>
        <Link className='transition transform hover:-translate-y-3 pb-3' to="/blog">BLOG</Link>
        <Link className='transition transform hover:-translate-y-3 pb-3' to="/about">ABOUT</Link>
        <Link className='transition transform hover:-translate-y-3' href="newsletter">CONTACT</Link>
      </div>
